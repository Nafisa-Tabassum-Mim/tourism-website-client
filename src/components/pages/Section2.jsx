            ...
            <div className="flex flex-col md:flex-row justify-center m-auto">
                ...
                <div className="m-8">
                    <div className="w-96 bg-base-100 shadow-xl p-8 my-4">
                        ...
                        <p className="text-gray-700 text-base">
                            ...
                            I am extremely satisfied with the product I purchased from this company. It exceeded my expectations in terms of quality and durability. The ordering process was seamless, and the delivery was prompt. I would definitely buy from them again.
                        </p>
                        <div className="px-6 py-4">
                            <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2">#ProductQuality</span>
                            <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700">#PromptDelivery</span>
                        </div>
                        <div className="flex text-4xl justify-around ">
                            <MdStarBorder className="text-yellow-400" /><MdStarBorder className="text-yellow-400" /><MdStarBorder className="text-yellow-400" />
                            <MdStarBorder className="text-yellow-400" />
                ...
                <div className="m-8">
                    <div className="w-96 bg-base-100 shadow-xl p-8 my-4">
                        ...
                        <p className="text-gray-700 text-base">
                            I recently visited this restaurant and had a wonderful dining experience. The food was delicious, and the atmosphere was cozy. The staff was attentive and provided excellent service. I will definitely be coming back!
                        </p>
